 ...
 * RTL: Icons swap to the right side, padding preserved.
 */
export const SearchInput = React.forwardRef<HTMLInputElement, SearchInputProps>(
  ({ className, onSearchChange, onChange, loading, inputClassName, ...props }, ref) => {
    ...
    return (
      ...
      >
        <span className="pointer-events-none flex shrink-0 items-center gap-1 rounded-l-lg rtl:rounded-l-none rtl:rounded-r-lg bg-gray-50/50 ps-3 pe-3 text-gray-400 transition-colors focus-within:text-primary-500 dark:bg-gray-800/50 dark:text-gray-500 group-focus-within/search:dark:bg-gray-900 rtl:flex-row-reverse">
