...
export function EmptySlotRow({ slot, onFillSlot }: EmptySlotRowProps) {
  ...
  return (
    <div className="relative group">
      <div className="transition-all duration-300 rounded-2xl border border-gray-100 bg-white dark:bg-gray-900 dark:border-gray-800 shadow-sm flex flex-col md:flex-row md:items-center justify-between p-5 hover:border-primary-200 dark:hover:border-primary-800">
